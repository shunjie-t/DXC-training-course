...
public class Hourly extends SalaryForMonth {
	...
	// branch
	Hourly(float pAmount,LocalDate cDate) {
		super(pAmount,cDate);
	}
	...
	public void computeSalary() {
		...
		System.out.printf("Basic salary: %.2f%n", normalPay);
		System.out.printf("Overtime salary: %.2f%n", overtimePay);
		System.out.printf("Performance bonus: %.2f%n", getPerformanceBonusAmount());
		System.out.printf("Gross salary: %.2f%n", totalPay);
	}
