...
public class PayrollSystem {
	...
	private ArrayList<Employee> retrieveEmployeeRecords() {
		...
		e.add(new Employee("F1290","John","Smith",LocalDate.of(1998, 2, 23),LocalDate.of(2022, 2, 1),"hourly",4000.00f));
		e.add(new Employee("F0312","Sean","Hoffman",LocalDate.of(1987,3,30),LocalDate.of(2015,9,1),"monthly",2500.00f));
		e.add(new Employee("F1292","Faye","Johnson", LocalDate.of(1997,5,12),LocalDate.of(2022,1,1),"commission",0.00f));
		e.add(new Employee("F0946","Leonard","Baumer",LocalDate.of(1971,7,5),LocalDate.of(2017,1,1),"monthly with commission",24.00f));
		return e;
	}
